          ...
          <div class="box box-primary">
            ...
            <form role="form" action="" method="post" enctype="multipart/form-data">
              {{csrf_field()}}
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="cost_per_unit" value="{{$service->cost_per_unit}}">
                </div>
                <div>
                <textarea name="notes" placeholder="About Services"
                 style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$service->notes}}"></textarea>
                </div>
                <div class="checkbox">
                  <label>
